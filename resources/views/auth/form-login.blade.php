        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-10">
            ...
            <form action="{{ route('login') }}" method="post" role="form" class="php-email-form">
              ...
              <div class="row">
                @if(config('laralag.login_using') == 'email')
                  <div class="col-md-6 form-group">
                    <input type="email" class="form-control" id="name" placeholder="Email" name="email" :value="old('email')" required autofocus>
                  </div>
                @else
                  <div class="col-md-6 form-group">
                    <input type="text" class="form-control" id="name" placeholder="Username" name="username" :value="old('username')" required autofocus>
                  </div>
                @endif
              ...
              <div class="text-center my-3"><button type="submit">Login</button></div>
            </form>
          </div>
